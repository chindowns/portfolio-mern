...
const seedDB = [
    ...
    },
    {
        ...
        projHighlights: "First fully deployed MERN app.",
    ...
    },
    {
        ...
        repo: "git@github.com:chindowns/tic-tac-toe.git",
        deploy: "https://chindowns.github.io/tic-tac-toe",
        devRole: "Author",
        skills: ["JavaScript", "ES6", "jQuery", "HTML5", "CSS"],
        description: "This clean fun game plays against the computer.  Have fun",
        projHighlights: "KISS - keep it simple",
        responsibilities: "Author",
        learnings: "Started with UIKit and then decided the cleanest look would be to the CSS from scratch."
    },
    {
        order: 6,
        name: "Connect-4",
        image: "connect-4.gif",
        repo: "git@github.com:chindowns/connect-4.git",
        deploy: "https://chindowns.github.io/connect-4",
        devRole: "Author",
        skills: ["JavaScript", "ES6", "jQuery", "HTML5", "CSS"],
        description: "This clean fun game plays against the computer.  Have fun! Connect Four (also known as Four Up, Plot Four, Find Four, Four in a Row, Four in a Line, Drop Four, and Gravitrips (in Soviet Union)) is a two-player connection board game in which the players first choose a color and then take turns dropping one colored disc from the top into a seven-column, six-row vertically suspended grid. The pieces fall straight down, occupying the lowest available space within the column. The objective of the game is to be the first to form a horizontal, vertical, or diagonal line of four of one's own discs. Connect Four is a solved game. The first player can always win by playing the right moves.",
        projHighlights: "KISS - keep it simple",
        responsibilities: "Author",
        learnings: "Before even writing code, plan and pseudo code.  Get something on screen, make it work, then make it better."
    },
    {
        order: 9,
        name: "JobKit",
